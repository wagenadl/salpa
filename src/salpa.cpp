...
void usage() {
  std::cerr
    ...
    << "   be forced. The file may either consist of lines containing single\n"
    << "   numbers, which are the timestamps of the pegs, or of lines containing\n"
    << "   pairs of numbers, where the first number is the timestamp of each peg,\n"
    << "   and the second number is the corresponding forcepeg sample count,\n"
    << "   which overrides the value passed through -f.\n"
    << "   -P and -p/-d are mutually exclusive.\n"
